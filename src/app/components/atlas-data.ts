...
export const INSIGHT_POOL: Record<TemplateId, InsightSeed[]> = {
  comercial: [
    {
      title: 'CAC subiu 15% nos últimos 15 dias, puxado pelo CPC da mídia paga 22% acima da média',
      summary: 'A alta se concentra nos anúncios pagos; os demais canais mantiveram o custo de aquisição estável no período.',
    ...
    {
      title: 'Propostas travam no fechamento, com 28 paradas há mais de 7 dias e conversão abaixo do setor',
      summary: 'A conversão de proposta para fechamento está em 35%, contra 42% em empresas do mesmo segmento.',
    ...
    {
      title: 'Indicação é o canal de menor custo e maior ticket, mas responde por só 18% do volume',
      summary: 'Cada cliente indicado custa R$ 28 e gera valor 28% acima da média, bem abaixo do custo da mídia paga.',
    ...
    {
      title: 'Sexta e sábado concentram 46% das vendas, enquanto o domingo fica 65% abaixo da média',
      summary: 'A concentração pressiona a operação no fim de semana e deixa capacidade ociosa nos demais dias.',
  ...
  financeiro: [
    {
      title: 'Faturamento caiu 8% nas últimas 3 semanas, concentrado nos produtos B e C',
      summary: 'O restante do portfólio se manteve estável no período, o que indica um problema localizado e não de demanda geral.',
    ...
    {
      title: 'Custos fixos chegam a 40% da estrutura, acima dos 35% de empresas do mesmo porte',
      summary: 'Os contratos recorrentes respondem pela maior parte da diferença em relação ao setor.',
    ...
    {
      title: 'Reajuste elevou o ticket médio de R$ 175 para R$ 187 sem queda relevante no volume',
      summary: 'O volume de pedidos se manteve estável nas semanas seguintes ao reajuste.',
      recommendation: null,
      impact: 'R$ 3,1K por mês adicionais', priority: 'baixa', type: 'tendencia', category: 'Preço', metric: 'Ticket médio',
    },
    {
      title: 'Margem de setembro chegou a 47%, a melhor do ano, puxada pelo mix de maior valor agregado',
      summary: 'Os itens de maior valor ganharam participação nas vendas do mês sem aumento no custo de aquisição.',
  ...
  clientes: [
    {
      title: 'Recompra caiu 18% no mês entre clientes com mais de 6 meses de casa, a faixa de maior valor',
      summary: 'Clientes mais novos mantiveram a frequência; a queda está concentrada na base mais antiga.',
    ...
    {
      title: 'Churn caiu para 4,2%, o menor patamar em 6 meses, após as mudanças no atendimento',
      summary: 'A melhora acompanha as iniciativas de atendimento iniciadas em agosto.',
    ...
    {
      title: '20% dos clientes reduziram a frequência de uso e estão em risco de cancelamento',
      summary: 'O grupo representa perda potencial relevante de receita recorrente no próximo ciclo de cobrança.',
  ...
  marketing: [
    {
      title: 'Custo por lead subiu 11% no mês, com a alta concentrada na mídia paga',
      summary: 'Os demais canais mantiveram o custo por lead estável no período.',
    ...
    {
      title: 'Canal orgânico converte 3,9% contra 2,4% da mídia paga, com custo por lead bem menor',
      summary: 'O orgânico gera menos volume, mas entrega leads mais qualificados e mais baratos.',
    ...
    {
      title: 'Campanha de setembro teve retorno de 3,6x sobre a mídia, o melhor resultado do ano',
      summary: 'O resultado ficou acima da média de 3,4x registrada nos meses anteriores.',
  ...
  orcamento: [
    {
      title: 'Realizado ficou 6,4% abaixo do orçado no mês: R$ 412K contra R$ 440K previstos',
      summary: 'Bruno Lima e Diego Rocha somam R$ 37K abaixo das suas metas e concentram o desvio do mês.',
    ...
    {
      title: 'Resultado está abaixo do orçado desde março, com desvio acumulado de R$ 151K no ano',
      summary: 'O desvio representa 4,6% do orçamento. Mantido o ritmo, o ano fecha em cerca de 95% do previsto.',
    ...
    {
      title: 'Ana Souza entregou 117% do orçado no mês, o quinto mês seguido acima da meta',
      summary: 'O ticket médio dela é 22% maior que o restante do time.',
    ...
    {
      title: 'Março e junho ficaram mais de 10% abaixo do orçado e concentram os maiores desvios do ano',
      summary: 'Os dois meses repetem o padrão sazonal observado no ano anterior.',
